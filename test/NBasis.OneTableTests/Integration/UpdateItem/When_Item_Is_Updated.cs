...
namespace NBasis.OneTableTests.Integration.UpdateItem
{
    ...
    public class When_Item_Is_Updated : OneTableTestBase<TestTableContext>
    {
        public When_Item_Is_Updated(DynamoDbDockerFixture fixture) : base(fixture)
        {
        }

        [Fact]
        public async Task Then_roundtrip_item_is_updated()
        {
